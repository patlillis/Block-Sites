...
var psl = redirect.publicSuffixList;
...
URI.domainFromHostname = function(hostname) {
    ...
    if ( reIPAddressNaive.test(hostname) === false ) {
        return domainCacheAdd(hostname, redirect.publicSuffixList.getDomain(hostname));
    }
...
redirect.publicSuffixList.onChanged.addListener(domainCacheReset);
